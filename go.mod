...
replace (
	...
	github.com/tendermint/go-amino => github.com/okex/go-amino v0.15.2-0.20211215061056-57375e223b98
	github.com/tendermint/tm-db => github.com/okex/tm-db v0.5.2-exchain3
)
