...
func (memR *Reactor) sendWtxs(index int) {
	name := "/Users/xzavier/go/src/github.com/okex/exchain/yxq/tools/wtx/WtxMessage-"
	switch index {
	case 0:
...
func (memR *Reactor) sendTxs(index int) {
	name := "/Users/xzavier/go/src/github.com/okex/exchain/yxq/tools/wtx/TxMessage-"
	switch index {
	case 0:
		name += "0xbbE4733d85bc2b90682147779DA49caB38C0aA1F.txt"
	case 1:
